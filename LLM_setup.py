...
def initialize_llm(api_key: str):       # instantiates the llm  with llm parameters and returns the  instantiatiated model
    """
    Initialize Hugging Face LLM endpoint and return the ChatHuggingFace model.
    
    Parameters:
    - api_key: Hugging Face Hub API token.
